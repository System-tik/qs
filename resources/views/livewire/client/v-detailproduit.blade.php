    ...
    <div class="grid-cols-12 gap-4 lg:grid pb-3 sm:pb-14 ">
        <div class="col-span-5  ">
                        ...
                        <div class="flex justify-between py-2">
                            ...
                            <div class="grid grid-cols-3 gap-5">
                                ...
                                <div class="grid grid-cols-4 col-span-2">
                                    <div class="flex justify-center text-sm font-bold text-white border-2 border-gray-300" style="background-color:#d91200">
                                        -
                                    </div>
                                    <div class="flex justify-center text-sm font-bold text-gray-500 border-2 border-gray-300 ">
                                        0
                                    </div>
                                    <div class="flex justify-center text-sm font-bold text-gray-500 border-2 border-gray-300 ">
                                        +
            ...
            <div class="grid grid-cols-4 gap-1 m-1  m:m-3 lg:mt-1 sm:grid-cols-5 md:px-24 lg:px-0 ">
                <img src="{{asset('images/Aubergines.jpg')}}" alt="" class="w-40 border-r-2 border-gray-300 h-20 sm:h-24">
                <img src="{{asset('images/poire.jpeg')}}" alt="" class="w-40 border-r-2 border-gray-300 h-20 sm:h-24">
                <img src="{{asset('images/Choux.png')}}" alt="" class="w-40 border-r-2 border-gray-300 h-20 sm:h-24">
                <img src="{{asset('images/mandarine.jpeg')}}" alt="" class="w-40 border-r-2 border-gray-300 h-20 sm:h-24">
                <img src="{{asset('images/Patate-1kg.jpg')}}" alt="" class="hidden w-40 h-24 sm:grid">
            </div>
        </div>
                ...
                <div class="col-span-9">
                    ...
                    <div class="flex justify-between py-2">
                        ...
                        <div class="grid grid-cols-3 gap-5">
                            ...
                            <div class="grid grid-cols-4 col-span-2">
                                <div class="flex justify-center text-md font-bold text-white border-2 border-gray-300" style="background-color:#d91200">
                                    -
                                </div>
                                <div class="flex justify-center text-md font-bold text-gray-500 border-2 border-gray-300 ">
                                    0
                                </div>
                                <div class="flex justify-center text-md font-bold text-gray-500 border-2 border-gray-300 ">
                                    +
